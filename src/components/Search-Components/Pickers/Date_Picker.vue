<template>
  <div class="flex flex-col items-center max-h-fit">
    ...
    <div class="flex flex-col items-center" v-if="selected_type == 2">
      ...
      <div class="flex items-center gap-4 pb-8 max-w-2xl overflow-x-scroll">
        <div v-for="mon in months" :key="mon.monthId" class="flex flex-col justify-center items-center min-w-[8rem] min-h-[10rem] rounded-lg border-[0.15rem] cursor-pointer"
