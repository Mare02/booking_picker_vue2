  ...
  <div class="flex flex-col items-center"> 
    <div class="flex items-center justify-between sm:justify-evenly sm:w-fit bg-gray-200 border-[0.1rem] 
      ...
      <div class="items-center hidden sm:flex">
        ...
        <div class="flex flex-col hover:bg-gray-300 p-2 pl-8 rounded-3xl transition-all relative" id="1" @click="logClick"
              :class="{'bg-white': selected_picker == 1}">
          ...
          <div class="p-4 bg-white rounded-2xl shadow-lg absolute top-20 right-[-2rem]" v-if="(selected_picker == 1)">
            <Location_Picker/>
          </div>
        </div>
        ...
        <div class="flex flex-col hover:bg-gray-300 p-2 px-6 rounded-3xl transition-all relative" id="2" @click="logClick"
              :class="{'bg-white': selected_picker == 2}">
        ...
        <div class="flex flex-col hover:bg-gray-300 p-2 px-6 rounded-3xl transition-all relative" id="3" @click="logClick"
              :class="{'bg-white': selected_picker == 3}">
          ...
          <div class="p-4 bg-white rounded-2xl shadow-lg absolute top-20 right-[-1rem]" v-if="selected_picker == 2 || selected_picker == 3">
        ...
        <div class="flex items-center hover:bg-gray-300 p-2 pl-6 rounded-3xl transition-all relative" id="4" @click="logClick"
             :class="{'bg-white': selected_picker == 4}">
          ...
          <div class="p-4 bg-white rounded-2xl shadow-lg absolute top-20 right-[-2rem]" v-if="selected_picker == 4">
            <Guests_Picker />
          </div>
        </div>
      </div>
    ...
    <div class="p-4 bg-white rounded-2xl shadow-lg absolute top-20">
      ...
      <!-- <Date_Picker v-if="selected_picker == 2 || selected_picker == 3" @dateInput="getSelectedDate"/> -->
      <!-- <Guests_Picker v-if="selected_picker == 4"/> -->
    </div>
  </div>
